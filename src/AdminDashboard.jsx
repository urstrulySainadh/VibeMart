...
const AdminDashboard = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      if (response.ok) {
        localStorage.removeItem("adminName");//this will remove admin name from localstorage
  ...
  //getting admin name from localstorage if found else name would be as admin
  ...
  return (
    <div className="admin-dashboard">
      ...
      <main className="dashboard-content">
        <p className="admin-dashboard-title">Admin Dashboard</p>
