...
const CartPage = () => {
  ...
  //redirecting to customer homepage for continuing shopping
  const handleShoppingContinue = () => {
    navigate('/customerhome'); // Navigate to the orders route
  };
  ...
  if (cartItems.length === 0) {
    return (
      <div className="cart-page empty">
        ...
        <p><a onClick={handleShoppingContinue}>Add some items </a>to get started!</p>
    ...
    <div style={{ width: "100vw" }}>
      ...
      <div className="cart-container">
        <div className="cart-page">
          <a onClick={handleShoppingContinue} className="back-button">
            ← Shopping Continue
          </a>
                ...
                <div className="item-details">
                  ...
                  <div className="item-actions">
                    <div className="quantity-controls">
                      <button className="cbtn" onClick={() => handleQuantityChange(item.product_id, item.quantity - 1)}>
                        -
                      </button>
